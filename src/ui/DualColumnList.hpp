...
[[nodiscard]] constexpr DualColumnLists dualColumnLists(const UiRect& contentBox,
    ...
    const int rowWidth = kTransferListWidth - kTransferRowInset;
    return DualColumnLists{
        ScrollList{centre - kTransferCentreGap - kTransferListWidth, y, kTransferListWidth,
                   height, rowWidth, kTransferRowHeight},
        ScrollList{centre + kTransferCentreGap, y, kTransferListWidth, height, rowWidth,
                   kTransferRowHeight},
    };
}
