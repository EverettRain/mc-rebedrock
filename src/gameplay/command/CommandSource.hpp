...
// The op level a command requires, mirroring vanilla's Commands.LEVEL_* ladder.
...
// The execution context a command runs against, mirroring vanilla's
...
struct CommandSource final {
    ...
    // The vanilla CommandSourceStack.withXxx derivations, as value copies — the
...
// different things in two commands (vanilla's Vec3Argument#getPosition against
