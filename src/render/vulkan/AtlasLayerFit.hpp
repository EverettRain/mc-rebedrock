...
// RN-4b removed conformBlockLayer: a vertical animation strip (magma, sea lantern,
// prismarine) is no longer capped to frame 0. bakeBlockAtlas now bakes every frame
// of such a strip contiguously and records a BlockTextureAnimation so the terrain
// shader cycles it, the same way it cycles the fluids. Non-strip block textures go
// straight through conformToAtlasLayer.
